...
def main():
    ...
    ## DTWF checks against pedigree sims
    verifier.add_dtwf_vs_pedigree_single_locus()
    verifier.add_dtwf_vs_pedigree_short_region()
    verifier.add_dtwf_vs_pedigree_long_region()
